                ...
                <Row>
                    <Col>
                        <Card title='Quick Installation' isOption>
                            ...
                            <p> - Unzip <code>mqtt-frontend.zip</code> file, Inside that directory you will find the <code>mqtt-frontend/</code> folder</p>
                            <p> - Open your terminal/cmd then navigate to project directory <code>mqtt-frontend/</code></p>
                            ...
                            <p> - Now, You can use Aptyx - Dashboard React Admin Template for your application development. </p>
                            ...
                            <p> - Build project using command <code>'npm run build'</code>, It will create <code>build/</code> folder inside mqtt-frontend/ folder. </p>
